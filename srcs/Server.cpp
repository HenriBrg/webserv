...
Server::Server(std::string name, int port, std::string error): name(name), port(port), error(error) {
    ...
    // Location *newLoc1 = new Location("/", "./www", "index.html", "GET", 100, "root:pass", "./www/cgi-bin/cgi_tester", "", "");
    // Location *newLoc2 = new Location("/tmp", "./www", "index.html", "GET,POST,HEAD", 100, "root:pass", "./www/cgi-bin/cgi_tester", "", "");
